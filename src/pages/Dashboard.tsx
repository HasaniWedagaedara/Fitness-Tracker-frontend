...
const Dashboard = () => {
  ...
  const totalActiveMinites: number = todayActivities.reduce(
  ...
  return (
    <div className="page-container">
      ...
      <div className="dashboard-header">
        <p className="textem100 text-sm font-medium">Welcome back</p>
      ...
      <div className="dashboard-grid">
        ...
        <div className="dashboard-card-grid">
          ...
          <Card>
            ...
            <p className="text-sm text-slate-400">actities logged</p>
          </Card>
        </div>

        {/* Goal card */}
        {user && ( // This card will span both columns pn large screens
          <Card className="bg-gradient-to-r from-slate-800 to-slate-700">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center">
                <TrendingUpDownIcon className="w-6 h-6 text-emerald-400" />
              </div>
              <div>
                <p className="to-slate-400 text-sm">Your Goal</p>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm tesl500 dark:text-slate-400">
                    Weight
                  </span>
                </div>
              ...
              {user.height && (
                <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-medium tesl700 dark:text-slate-300">
                      BMI
                    </span>
                    {(() => {
                      const bmi = (
                  ...
                  {/* BMI scale visual */}
                  <div className="h-2 w-full bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden opacity-30">
        ...
        {/* Quick Sumery */}
        <Card>
          <h3 className="font-semibold tessl800 dark:text-white mb-4">
            Today's Summery
          </h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b borsl100 dark:border-slate-400">
